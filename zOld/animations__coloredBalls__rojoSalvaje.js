let buttonColor1Rojo = document.getElementById("ballsRojo_1");
let buttonColor2Rojo = document.getElementById("ballsRojo_2");
let buttonColor3Rojo = document.getElementById("ballsRojo_3");

let canvasOpacity = document.getElementById("canvasRojo");
...
function activateColor1() {
    ...
    buttonColor1Rojo.removeEventListener('click', activateColor1);
    buttonColor2Rojo.removeEventListener('click', activateColor2);
    buttonColor3Rojo.removeEventListener('click', activateColor3);
    buttonColor4Rojo.removeEventListener('click', activateColor4);
...
buttonColor1Rojo.addEventListener('click',activateColor1);
buttonColor2Rojo.addEventListener('click',activateColor2);
buttonColor3Rojo.addEventListener('click',activateColor3);
buttonColor1Rojo.addEventListener('click',returnColor1);
buttonColor2Rojo.addEventListener('click',returnColor2);
buttonColor3Rojo.addEventListener('click',returnColor3);
    ...
    function ballsReady() {
        ...
        canvas = document.getElementById('canvasRojo');
