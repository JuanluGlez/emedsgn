let buttonColor1Ferro = document.getElementById("ballsFerro_1");
let buttonColor2Ferro = document.getElementById("ballsFerro_2");
let buttonColor3Ferro = document.getElementById("ballsFerro_3");

let canvasOpacity = document.getElementById("canvasFerro");
...
function activateColor1() {
    ...
    buttonColor1Ferro.removeEventListener('click', activateColor1);
    buttonColor2Ferro.removeEventListener('click', activateColor2);
    buttonColor3Ferro.removeEventListener('click', activateColor3);
    buttonColor4Ferro.removeEventListener('click', activateColor4);
...
buttonColor1Ferro.addEventListener('click',activateColor1);
buttonColor2Ferro.addEventListener('click',activateColor2);
buttonColor3Ferro.addEventListener('click',activateColor3);
buttonColor1Ferro.addEventListener('click',returnColor1);
buttonColor2Ferro.addEventListener('click',returnColor2);
buttonColor3Ferro.addEventListener('click',returnColor3);
    ...
    function ballsReady() {
        ...
        canvas = document.getElementById('canvasFerro');
