let buttonColor1Fortunatas = document.getElementById("ballsFortunatas_1");
let buttonColor2Fortunatas = document.getElementById("ballsFortunatas_2");
let buttonColor3Fortunatas = document.getElementById("ballsFortunatas_3");
let buttonColor4Fortunatas = document.getElementById("ballsFortunatas_4");
let canvasOpacity = document.getElementById("canvas3");
...
function activateColor1() {
    ...
    buttonColor1Fortunatas.removeEventListener('click', activateColor1);
    buttonColor2Fortunatas.removeEventListener('click', activateColor2);
    buttonColor3Fortunatas.removeEventListener('click', activateColor3);
    buttonColor4Fortunatas.removeEventListener('click', activateColor4);
...
buttonColor1Fortunatas.addEventListener('click',activateColor1);
buttonColor2Fortunatas.addEventListener('click',activateColor2);
buttonColor3Fortunatas.addEventListener('click',activateColor3);
buttonColor4Fortunatas.addEventListener('click',activateColor4);
buttonColor1Fortunatas.addEventListener('click',returnColor1);
buttonColor2Fortunatas.addEventListener('click',returnColor2);
buttonColor3Fortunatas.addEventListener('click',returnColor3);
buttonColor4Fortunatas.addEventListener('click',returnColor4);
