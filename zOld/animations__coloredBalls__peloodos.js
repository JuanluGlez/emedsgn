let buttonColor1Peloodos = document.getElementById("ballsPeloodos_1");
let buttonColor2Peloodos = document.getElementById("ballsPeloodos_2");
let buttonColor3Peloodos = document.getElementById("ballsPeloodos_3");
let buttonColor4Peloodos = document.getElementById("ballsPeloodos_4");

let canvasOpacity = document.getElementById("canvas2");

ballsColor = null;

function activateColor1() {

    ballsReady()
    ballsColor = "#f7dd6b";
    canvasOpacity.style.opacity = 1;
    buttonColor1Peloodos.removeEventListener('click', activateColor1);
    buttonColor2Peloodos.removeEventListener('click', activateColor2);
    buttonColor3Peloodos.removeEventListener('click', activateColor3);
    buttonColor4Peloodos.removeEventListener('click', activateColor4);
    buttonColor5Peloodos.removeEventListener('click', activateColor5);

}

function activateColor2() {
...
console.log(ballsColor);

buttonColor1Peloodos.addEventListener('click',activateColor1);
buttonColor2Peloodos.addEventListener('click',activateColor2);
buttonColor3Peloodos.addEventListener('click',activateColor3);
buttonColor4Peloodos.addEventListener('click',activateColor4);

buttonColor1Peloodos.addEventListener('click',returnColor1);
buttonColor2Peloodos.addEventListener('click',returnColor2);
buttonColor3Peloodos.addEventListener('click',returnColor3);
buttonColor4Peloodos.addEventListener('click',returnColor4);
