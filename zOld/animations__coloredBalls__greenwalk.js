let buttonColor1 = document.getElementById("ballsGW_1");
let buttonColor2 = document.getElementById("ballsGW_2");
let buttonColor3 = document.getElementById("ballsGW_3");
let canvasOpacity = document.getElementById("canvas1");
...
function activateColor1() {
    ...
    buttonColor1.removeEventListener('click', activateColor1);
    buttonColor2.removeEventListener('click', activateColor2);
    buttonColor3.removeEventListener('click', activateColor3);
...
buttonColor1.addEventListener('click',activateColor1);
buttonColor2.addEventListener('click',activateColor2);
buttonColor3.addEventListener('click',activateColor3);
buttonColor1.addEventListener('click',returnColor1);
buttonColor2.addEventListener('click',returnColor2);
buttonColor3.addEventListener('click',returnColor3);
